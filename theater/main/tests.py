...
class RoomTest(TestCase):
    ...
    def test_room(self):
        ...
        self.assertEqual(room_1.__str__(), "Room-1")
        self.assertEqual(room_2.__str__(), "roomtwo")
...
class MovieTest(TestCase):
    ...
    def test_movie(self):
        ...
        self.assertEqual(movie_godfather.__str__(), "Godfather")
        self.assertEqual(movie_pulpfiction.__str__(), "Pulp Fiction")
